...
function Jugador({ children, jugador }) {
    return (
        <div className="bg-gray-300 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 mb-4">
            <div className="">
                <h2 className="text-xl font-bold text-gray-800 mb-2 hover:text-cyan-600 transition duration-300">{jugador.nombre} {jugador.apellido}</h2>
                <div className="text-sm text-gray-600">
                    ...
                    <p className="flex items-center">
                        ...
                        {jugador.fechaNacimiento.toLocaleDateString('es-ES')}
                    </p>
                </div>
            </div>
            {children}
