                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link legacyBehavior href="/" className="flex items-center">
                            <div>
                                <img src="/logo.png" className="rounded h-20 w-36 me-3" alt="SC360 Logo" />
                            </div>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link legacyBehavior href="#" className="hover:underline">Acerca de</Link>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                <li className="ml-5 mb-3">
                                    <a href="https://github.com/Toniitop" className="flex items-center hover:underline">
                                ...
                                <li className="ml-4">
                                    <a href="https://www.instagram.com/82consejos/?hl=es" className="flex items-center hover:underline">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link legacyBehavior href="#" className="hover:underline">Política de Privacidad</Link>
                                </li>
                                <li>
                                    <Link legacyBehavior href="#" className="hover:underline">Terminos y Condiciones</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
