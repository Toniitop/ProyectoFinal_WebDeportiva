...
function Footer() {
    return (
        <section className="bg-teal-600 border-t border-yellow-500">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-300 font-medium">
                                <li className="mb-4 hover:text-white">
                                    <Link legacyBehavior href="/about" className="">Sobre nosotros</Link>
                                </li>
                                <li className="hover:text-white">
                                    <Link legacyBehavior href="/acercaDe" className="hover:underline">Acerca De</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="font-medium flex">
                                <li className="ml-5 mb-3 transition-transform duration-300 hover:scale-110 brightness-150">
                                ...
                                <li className="ml-4 transition-transform duration-300 hover:scale-110 brightness-150">
                            ...
                            {/* RECURSO AUXILIAR PARA PODER REGISTRAR DESDE 0 */}
                ...
                <div className="mx-auto text-center">
                    <span className="text-sm text-lime-200">© 2024 - SC360™ - All Rights Reserved.</span>
                </div>
            </div>
        </section>
    )
