                ...
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <Link legacyBehavior href="/">
                            <img className="rounded w-10 h-10 lg:h-10" src="/logoPeque.png" alt="Logo" />
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        {session ? (
                            ...
                            <div className="flex">
                                {/* Boton para registar con credenciales, evitar esto, porque sólo lo hace el admin */}
                                {/* <Link legacyBehavior href="/auth/register">
                                    <a className="hidden md:inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-teal-600 transition duration-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                                        SignUp
                                    </a>
                                </Link> */}
