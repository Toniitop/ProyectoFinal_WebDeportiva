    ...
    return (
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="max-w-4xl mx-auto p-12 bg-gray-200 rounded-lg shadow-lg my-8">
                <h1 className="text-4xl font-bold mb-12 italic text-green-600 text-center">Sobre la Gestión Deportiva de Nuestro Club</h1>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="md:col-span-1">
                        <h2 className="text-2xl font-bold mb-4 text-green-600 text-center">Bienvenido a Nuestro Club Deportivo</h2>
                ...
                <div className="my-8">
                    <h3 className="text-xl text-green-600 font-bold mb-2">Nuestra Misión:</h3>
                ...
                <div className="my-8">
                    <h3 className="text-xl text-green-600 font-bold mb-2">Nuestros Servicios:</h3>
